  ...
  return (
    <div className="min-h-screen pt-16">
            ...
            {statistics.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="relative mb-4">
                  <div className="w-24 h-24 mx-auto bg-gradient-to-br from-[#111166] to-[#2a2a88] rounded-2xl flex items-center justify-center shadow-modern group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="text-lg font-semibold text-gray-900 dark:text-[#fff0ff]">
                  {stat.label}
                </div>
              </div>
            ))}
              ...
              <div key={index} className="modern-card p-8 group bg-white dark:bg-[#000000] border border-[#b4b1f8] dark:border-[#073763]">
                ...
                <ul className="space-y-3">
                  {strength.details.map((detail, detailIndex) => (
                    <li key={detailIndex} className="flex items-start text-gray-600 dark:text-[#85828d]">
                      <div className="w-6 h-6 bg-gradient-to-br from-[#ffa4ff] to-[#ff7bff] rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {facilities.map((facility, index) => (
              <div key={index} className="modern-card overflow-hidden group bg-white dark:bg-[#000000] border border-[#b4b1f8] dark:border-[#073763]">
                <div className="relative h-64 bg-gray-200 dark:bg-[#4d5464] overflow-hidden">
                  <img 
                  ...
                  <div className="absolute top-4 left-4 w-12 h-12 bg-white/90 backdrop-blur-sm rounded-xl flex items-center justify-center">
                    <i className="fas fa-university text-[#111166] text-lg"></i>
                  </div>
                </div>
                <div className="p-8">
                  ...
                  <div className="mt-6 flex items-center text-[#111166] dark:text-[#ffa4ff] font-semibold group-hover:text-[#2a2a88] dark:group-hover:text-[#ff7bff] transition-colors">
              ...
              <div key={index} className="modern-card p-8 group bg-white dark:bg-[#000000] border border-[#b4b1f8] dark:border-[#073763]">
                <div className="flex items-center mb-6">
                  <div className="relative mr-4">
                    ...
                    />
                    <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-br from-[#ffa4ff] to-[#ff7bff] rounded-full flex items-center justify-center">
                      <i className="fas fa-check text-white text-xs"></i>
                    </div>
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#111166] dark:text-[#ffa4ff] font-medium">
                      {testimonial.program} Graduate
                    </p>
                    <p className="text-sm text-gray-600 dark:text-[#85828d]">
                      {testimonial.position}
                    </p>
                  </div>
                </div>
                <div className="relative">
                  <div className="absolute -top-2 -left-2 text-3xl text-[#b4b1f8] dark:text-[#073763] opacity-50">
                    <i className="fas fa-quote-left"></i>
                  </div>
                  <p className="text-gray-600 dark:text-[#85828d] italic leading-relaxed relative z-10">
                    "{testimonial.quote}"
                  </p>
                </div>
                <div className="flex items-center justify-between mt-6">
                  ...
                  <div className="text-sm text-gray-500 dark:text-[#67666e]">
                    Verified Graduate
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="fade-in-up">
              ...
              <p className="text-xl text-gray-600 dark:text-[#85828d] mb-8 leading-relaxed">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start group">
                    <div className="w-8 h-8 bg-gradient-to-br from-[#ffa4ff] to-[#ff7bff] rounded-full flex items-center justify-center mr-4 mt-1 group-hover:scale-110 transition-transform duration-300">
                      <i className="fas fa-check text-white text-sm"></i>
                    </div>
                    <span className="text-gray-600 dark:text-[#85828d] text-lg">{item}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="flex justify-center slide-in-right">
              <div className="relative">
                <div className="w-full max-w-md h-80 bg-gradient-to-br from-[#111166] via-[#b4b1f8] to-[#ffa4ff] rounded-3xl flex items-center justify-center shadow-modern-xl">
                ...
                {/* Floating elements */}
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br from-[#ffa4ff] to-[#ff7bff] rounded-full flex items-center justify-center shadow-lg">
                  <i className="fas fa-trophy text-white text-xl"></i>
                </div>
                <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-br from-[#b4b1f8] to-[#8a85f5] rounded-full flex items-center justify-center shadow-lg">
      ...
      <section className="py-24 gradient-bg relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/programs" className="btn-secondary group border border-[#111166] text-[#111166] hover:bg-[#111166] hover:text-white dark:border-[#ffa4ff] dark:text-[#ffa4ff] dark:hover:bg-[#ffa4ff] dark:hover:text-[#000000]">
              <span className="flex items-center justify-center">
                Explore Programs
      ...
      <style jsx>{`
        ...
        .shadow-modern-xl {
          box-shadow: 0 20px 60px rgba(17, 17, 102, 0.2);
        }
        
        .dark .shadow-modern-xl {
          box-shadow: 0 20px 60px rgba(255, 164, 255, 0.2);
        }
